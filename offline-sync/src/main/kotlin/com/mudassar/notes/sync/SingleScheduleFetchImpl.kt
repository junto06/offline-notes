...
class SingleScheduleFetchImpl @Inject constructor(
    @ApplicationContext private val context: Context,
    private val sessionRepository: SessionRepository,
) : SingleScheduleFetch {

    override suspend fun schedule() {
        // Ignore fetch if not loggedIn
        ...
        val request = OneTimeWorkRequestBuilder<FetchNotesWorker>()
