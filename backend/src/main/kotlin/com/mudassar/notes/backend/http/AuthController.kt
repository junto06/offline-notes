...
import com.mudassar.notes.backend.domain.usecase.SignupUseCase
...
class AuthController(
    ...
    fun ClientContext.signup(@Valid @RequestBody request: SignupRequestDto): SignupResponseDto =
        signupUseCase(request.email, request.password, request.name).toDto()
